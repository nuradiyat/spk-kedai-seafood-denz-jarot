{{-- 
================================================================
components/tables/penilaian-table.blade.php
Komponen tabel daftar penilaian reusable.
    ...
    <table class="w-full text-sm">
        ...
        <thead class="bg-slate-50 border-b border-slate-200">
            ...
            <tr>
                ...
                <th
                    class="px-6 py-3.5 text-left text-[11px]
                ...
                <th
                    class="hidden sm:table-cell px-4 py-3.5
                ...
                <th
                    class="hidden md:table-cell px-4 py-3.5
                           text-left text-[11px]
                           font-semibold text-slate-400 uppercase">
                    Dibuat Oleh
                </th>
                ...
                <th
                    class="px-4 py-3.5 text-center text-[11px]
                           font-semibold text-slate-400 uppercase">
                    Aksi
                </th>
        ...
        <tbody>
            ...
            @forelse($penilaians as $index => $penilaian)
                <tr class="border-b border-slate-50 last:border-0">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-heading font-bold text-ocean text-sm">
                                    ...
                                    {{ \Carbon\Carbon::parse($penilaian->periode)->translatedFormat('F Y') }}
                    ...
                    <td class="hidden sm:table-cell px-4 py-4 text-center">
                        ...
                        <span
                            class="inline-flex items-center justify-center
                                     w-9 h-9 rounded-xl
                                     bg-ocean/10 text-ocean font-bold">
                    ...
                    {{-- USER --}}
                    <td class="hidden md:table-cell px-4 py-4 text-xs text-slate-500">
