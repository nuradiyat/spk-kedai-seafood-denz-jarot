...
@section('content')
    ...
    <div class="flex items-center gap-3 mb-5">
        ...
        <div>
            <h2 class="font-heading font-bold text-ocean text-xl">Tambah Penilaian Karyawan</h2>
            <p class="text-slate-400 text-sm mt-0.5">Isi Penilaian karyawan di bawah ini</p>
        </div>
    </div>
