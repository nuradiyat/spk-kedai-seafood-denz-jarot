{{-- 
================================================================
FILE    : roles/admin/sidebar.blade.php
FUNGSI  : Sidebar khusus admin
================================================================
--}}
...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5">
        ...
        <a href="{{ route('penilaian.index') }}"
            ...
            <i class="fas fa-star w-4 text-center shrink-0"></i>
            Input Penilaian
        </a>
        ...
        <a href="{{ route('hasil.index') }}"
            ...
            <i class="fas fa-calculator w-4 text-center shrink-0"></i>
            Perhitungan SAW
        </a>
